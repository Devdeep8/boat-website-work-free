...
const EMAIL = "vishalboatservice@gmail.com";
const DISPLAY_PHONE = "+91 87791 63152";
    ...
    <>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.a
                ...
                className="group relative bg-white rounded-2xl p-8 border border-gray-100 hover:shadow-lg transition-all"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
              >
                <div className="absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-5 transition-opacity duration-500 from-[#59b280]/10 to-transparent" />
                <div className="relative">
                  <div className="text-4xl mb-4">{contact.icon}</div>
                  <h3 className="font-instrument text-xl font-semibold text-[#064e3b] mb-2">{contact.title}</h3>
                  <p className="text-sm text-[#065f46] mb-3">{contact.description}</p>
                  <p className="text-[#59b280] font-medium">{contact.value}</p>
                </div>
              </motion.a>
            ))}
          </div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="text-[#59b280] text-sm font-semibold tracking-[0.2em] uppercase">FAQ</span>
            <h2 className="font-instrument text-4xl font-semibold text-[#064e3b] mt-4">Common Questions</h2>
          </motion.div>
          ...
          <div className="space-y-4">
            {[
              ...
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
              >
                <h3 className="font-semibold text-[#064e3b] mb-2">{faq.question}</h3>
                <p className="text-[#065f46]">{faq.answer}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-[#59b280] to-[#4a9a6d]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-instrument text-4xl font-semibold text-[#ffffff] mb-6">
            Ready to Book?
          </h2>
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-[#064e3b] hover:bg-[#0a1628] text-white font-semibold px-10 py-4 rounded-full transition-all"
          >
